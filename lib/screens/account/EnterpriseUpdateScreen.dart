...
class EnterpriseUpdateScreen extends StatefulWidget {
...
class EnterpriseUpdateScreenState extends State<EnterpriseUpdateScreen>
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 15),
                            Text(Utils.getImageUrl(item.logo)),
                            ImagePickerWidget(
                              logo_path,
                              item.logo,
                              'School Badge Photo',
  ...
  submit_form() async {
    ...
    if (logo_path.isNotEmpty) {
      data['logo_path'] =
          await DIO.MultipartFile.fromFile(logo_path, filename: logo_path);
    }

    RespondModel resp =
        RespondModel(await Utils.http_post('enterprise-create', data));
