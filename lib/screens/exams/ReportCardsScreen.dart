...
class ReportCardsScreen extends StatefulWidget {
  ...
  ReportCardsScreen(this.params, this.activeReportCard, {super.key});

  @override
  ReportCardsScreenState createState() => ReportCardsScreenState();
}

class ReportCardsScreenState extends State<ReportCardsScreen> {
          ...
          title: searchMode
              ...
              : Column(
                  ...
                  children: [
                    ...
                    FxText.titleMedium(
                      'Report cards ${activeClass.id > 0 ? ' - For ${activeClass.name}' : ''} ',
                      color: Colors.white,
                      fontWeight: 700,
                      height: .6,
                    ),
                    ...
                    FxText.bodySmall(
                      'Found ${Utils.moneyFormat(displayItems.length.toString())} records ${activeSubject.id > 0 ? ', for ${activeSubject.subject_name}' : ''}',
                      color: Colors.white,
                      height: 1,
                    ),
                  ],
                  ...
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (BuildContext context, int index) {
                        MarkRecordModel m = displayItems[index];
                      ...
                      childCount: displayItems.length, // 1000 list items
                    ),
                  )
                ],
              ),
  ...
  List<MarkRecordModel> displayItems = [];
  bool loading = false;
