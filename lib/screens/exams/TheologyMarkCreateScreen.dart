...
import '../../models/TheologyMarkRecordModel.dart';
...
//TheologyMarkCreateScreen
class TheologyMarkCreateScreen extends StatefulWidget {
  TheologyTermlyReportCard activeReportCard;
  TheologyMarkRecordModel mark;

  TheologyMarkCreateScreen(this.mark, this.activeReportCard, {super.key});

  @override
  TheologyMarkCreateScreenState createState() =>
      TheologyMarkCreateScreenState();
}

class TheologyMarkCreateScreenState extends State<TheologyMarkCreateScreen> {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            titleValueWidget2(
                                'CLASS', (widget.mark.theology_class_text)),
                            titleValueWidget2(
                                'SUBJECT', (widget.mark.theology_subject_text)),
                            const SizedBox(
                              height: 10,
                            ),
                            Divider(
  ...
  Future<void> do_submit() async {
    ...
    RespondModel resp =
        RespondModel(await Utils.http_post('theology-mark-records-update', {
    ...
    TheologyMarkRecordModel rec = TheologyMarkRecordModel.fromJson(resp.data);
